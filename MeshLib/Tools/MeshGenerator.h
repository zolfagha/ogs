...
public:
    ...
    static std::auto_ptr<StructuredMesh> generateStructuredRegularQuadMesh(const double length, const size_t subdivision, const double origin_x, const double origin_y, const double origin_z) 
    {
        CoordinateSystem coord(CoordinateSystem::CoordinateSystemType::XY);
        ...
        std::auto_ptr<StructuredMesh> msh(new StructuredMesh(coord, org, pt_length, pt_unit_len));
