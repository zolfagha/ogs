...
template <class T_USER_FEM_PROBLEM>
SingleStepKinReduction<T_USER_FEM_PROBLEM>::SingleStepKinReduction(MyDiscreteSystem* dis, UserFemProblem* problem)
...
template <class T_USER_FEM_PROBLEM>
int SingleStepKinReduction<T_USER_FEM_PROBLEM>::solveTimeStep(const NumLib::TimeStep &t_n1)
{
    //// time step
