 ...
 *
 *
 * \file FemVariableBuilderEta.cpp
 *
 * Created on 2012-11-16 by Haibing Shao
 */

#include "FemVariableBuilderEta.h"
...
void FemVariableBuilderEta::doit(const std::string &given_var_name, const BaseLib::Options &option, const MeshLib::IMesh* msh, const GeoLib::GEOObjects *geo, const std::string &geo_unique_name, FemLib::LagrangianFeObjectContainer* _feObjects, SolutionLib::FemVariable* var) const
{
