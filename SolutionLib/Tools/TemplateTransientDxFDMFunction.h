...
#include "NumLib/TransientAssembler/StencilWiseTransientDxEQSAssembler.h"
...
template <
    ...
    >
class TemplateTransientDxFDMFunction
...
public:
    ...
    TemplateTransientDxFDMFunction(UserFemProblem* problem, UserLocalJacobianAssembler* asssembler, DiscreteLib::IDiscreteLinearEquation* linear_eqs)
    ...
    ///
	virtual ~TemplateTransientDxFDMFunction() {};

	///
    MathLib::TemplateFunction<MyFemVector,MyFemVector>* clone() const
	{
    	return new TemplateTransientDxFDMFunction<
    				T_USER_FEM_PROBLEM,
    ...
    void eval(const MyFemVector &u_n1, const MyFemVector &r, MyFemVector &du)
    {
        ...
        NumLib::StencilWiseTransientDxEQSAssembler assembler(&t_n1, &vec_un, &vec_un1, _local_assembler);
