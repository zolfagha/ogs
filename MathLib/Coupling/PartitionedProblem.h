...
//    /// add parameter without giving reference
//    InternalID addInputParameter(ExternalKey key);
//
//    /// add parameter and reference
//    /// @param name variable name
//    /// @param sys problem
//    /// @param internal_id parameter id in the sys
//    /// @return parameter id
//    InternalID addOutputParameter(ExternalKey key, ICoupledSystem &sub_problem, size_t para_id_in_sub_problem);
//
//    /// connect system input and shared variable
//    void connectInput(InternalID key, ICoupledSystem &subproblem, size_t subproblem_para_id);
//
//    /// find subproblem
