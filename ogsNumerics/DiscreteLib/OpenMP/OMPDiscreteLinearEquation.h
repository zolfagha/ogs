...
#include "DiscreteLib/Serial/AbstractMeshBasedDiscreteLinearEquation.h"
...
class OMPDiscreteLinearEquation : public AbstractMeshBasedDiscreteLinearEquation
{
private:
    /// constructor
    /// \param msh
    /// \param linear_solver
    /// \param dofManager
    OMPDiscreteLinearEquation(const MeshLib::IMesh* msh, T_LINEAR_SOLVER* linear_solver, DofEquationIdTable* dofManager)
        : AbstractMeshBasedDiscreteLinearEquation(msh, dofManager), _eqs(linear_solver), _do_create_eqs(true)
    {
    };

public:
    static OMPDiscreteLinearEquation<T_LINEAR_SOLVER,T_SPARSITY_BUILDER>* createInstance(IDiscreteSystem &dis_sys, const MeshLib::IMesh* msh, T_LINEAR_SOLVER* linear_solver, DofEquationIdTable* dofManager)
    {
        OMPDiscreteLinearEquation<T_LINEAR_SOLVER,T_SPARSITY_BUILDER> *eqs;
        eqs = new OMPDiscreteLinearEquation<T_LINEAR_SOLVER,T_SPARSITY_BUILDER>(msh, linear_solver, dofManager);
...
private:
    DISALLOW_COPY_AND_ASSIGN(OMPDiscreteLinearEquation);
